...
export class NodeConnection extends Control implements DrawableControl {
    ...
    constructor(pinStart: PinControl, pinEnd: PinControl) {
        super(pinStart.position.x, pinStart.position.y);
        ...
        this._lineWidth = (this._pinStart.pinProperty.isExecutionPin) ? 2.5 : 1.5;
    }

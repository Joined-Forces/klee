...
import { CallFunctionNodeObject, KnotNodeObject, NodeObject, VariableGetNodeObject } from "./node-object";
...
export class PinProperty extends CustomProperty {
    ...
    get isHidden(): boolean {
        if (this.node instanceof VariableGetNodeObject) {
            let getNode = this.node as VariableGetNodeObject;
            return this.pinName === "self" && getNode.variableReference.selfContext;
        }
        if (this.node instanceof CallFunctionNodeObject) {
    ...
    get isKnotPin(): boolean {
        return this.node instanceof KnotNodeObject;
    }
